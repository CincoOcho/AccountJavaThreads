...
public class Banco {
    ...
    public  void Trasnferir(Cuenta origen, int destino, int monto) throws InterruptedException {
        ...
        try {
            //principio txt
            String header = "*************************"+origen.getNombre()+"***********"; 
            ...
            //end
            String fin = "\nsaldo  de la cuenta origen "+origen.getSaldo()+" final despues de  trasnferir:"
                    +cuentas[destino].getSaldo();
            System.out.println(fin);
            
            l.guardarTransferencia(header+inicio+actual+fin, origen.getNombre());
    ...
    public synchronized void transferirOtro(Cuenta destino1,Cuenta destino2, int posicion1,int posicion2, int monto) {
        ...
        try {
            ...
            String f = "\nSaldo  de la cuenta origen"+destino1.getSaldo()+
